export const selectAllMonthsQuery = "SELECT_ALL_MONTHS";
export const selectMonthStatsQuery = "SELECT_MONTH_STATS";
export const selectMonthDaysQuery = "SELECT_MONTH_DAYS";
